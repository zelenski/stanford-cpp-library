 ...
 */
#define STANFORD_CPP_LIB_VERSION "2016/11/29"
 ...
 *       if month or day is < 10, insert a preceding 0
 */
#define STANFORD_CPP_PROJECT_MINIMUM_VERSION "2016/11/07"
 ...
 *       if month or day is < 10, insert a preceding 0
 */
#define STANFORD_JAVA_BACKEND_MINIMUM_VERSION "2016/11/29"
