...
namespace redi
{
  ...
  template <typename CharT, typename Traits = std::char_traits<CharT> >
    ...
    public:
      ...
      : istream_type(nullptr), pbase_type(cmd, readable(mode))
      { }
      ...
      : istream_type(nullptr), pbase_type(argv.at(0), argv, readable(mode))
      { }
  ...
  template <typename CharT, typename Traits = std::char_traits<CharT> >
    ...
    public:
      ...
      /// Default constructor, creates an uninitialised stream.
      basic_opstream()
      : ostream_type(nullptr), pbase_type()
      { }
      ...
      : ostream_type(nullptr), pbase_type(cmd, mode|pstdin)
      { }
      ...
      : ostream_type(nullptr), pbase_type(argv.at(0), argv, mode|pstdin)
      { }
  ...
  template <typename CharT, typename Traits = std::char_traits<CharT> >
    ...
    public:
      ...
      /// Default constructor, creates an uninitialised stream.
      basic_pstream()
      : iostream_type(nullptr), pbase_type()
      { }
      ...
      : iostream_type(nullptr), pbase_type(cmd, mode)
      { }
      ...
      : iostream_type(nullptr), pbase_type(argv.at(0), argv, mode)
      { }
  ...
  template <typename CharT, typename Traits = std::char_traits<CharT> >
    ...
    public:
      ...
      /// Default constructor, creates an uninitialised stream.
      basic_rpstream()
      : ostream_type(nullptr), istream_type(nullptr), pbase_type()
      { }
      ...
      : ostream_type(nullptr) , istream_type(nullptr) , pbase_type(cmd, mode)
      { }
      ...
      : ostream_type(nullptr), istream_type(nullptr),
    ...
    basic_pstreambuf<C,T>::open(const std::string& command, pmode mode)
    {
      ...
      if (!is_open())
      {
        ...
        case 0 :
          ...
          ::execl(shell_path, "sh", "-c", command.c_str(), (char*) nullptr);
   ...
   * nullptr will be returned and the error code set to EPERM.
   *
   * @param   signal  A signal to send to the child process.
   * @return  @c this on success or @c nullptr on failure.
   */
  template <typename C, typename T>
    inline basic_pstreambuf<C,T>*
