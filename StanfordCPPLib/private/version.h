 ...
 */
#define STANFORD_CPP_LIB_VERSION "2016/10/18"
 ...
 *       if month or day is < 10, insert a preceding 0
 */
#define STANFORD_CPP_PROJECT_MINIMUM_VERSION "2016/10/14"
 ...
 *       if month or day is < 10, insert a preceding 0
 */
#define STANFORD_JAVA_BACKEND_MINIMUM_VERSION "2016/10/16"
