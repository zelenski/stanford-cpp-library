 ...
 */
#define STANFORD_CPP_LIB_VERSION "2016/09/26"
 ...
 *       if month or day is < 10, insert a preceding 0
 */
#define STANFORD_CPP_PROJECT_MINIMUM_VERSION "2016/09/22"
 ...
 *       if month or day is < 10, insert a preceding 0
 */
#define STANFORD_JAVA_BACKEND_MINIMUM_VERSION "2016/09/26"
