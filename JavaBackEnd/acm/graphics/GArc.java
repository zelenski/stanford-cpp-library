...
public class GArc extends GObject implements GFillable {
	...
	protected void paint2d(Graphics2D graphics2d) {
		java.awt.geom.Arc2D.Double double1 = new java.awt.geom.Arc2D.Double(0.0D, 0.0D, frameWidth,
				frameHeight, arcStart, arcSweep, isFilled() ? 2 : 0);
		if (isFilled()) {
	...
	public final void setFrameRectangle(GRectangle grectangle) {
		setFrameRectangle(grectangle.getX(), grectangle.getY(), grectangle.getWidth(),
	...
	public String paramString() {
		...
		String s1 = (new StringBuilder()).append("frame=(").append(grectangle.getX()).append(", ")
				.append(grectangle.getY()).append(", ").append(grectangle.getWidth()).append(", ")
				.append(grectangle.getHeight()).append(")").toString();
		s1 = (new StringBuilder()).append(s1).append(", start=").append(arcStart)
				.append(", sweep=").append(arcSweep).toString();
