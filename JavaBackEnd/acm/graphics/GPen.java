...
public class GPen extends GObject {
	...
	public void setLocation(double d, double d1) {
		if (regionStarted) {
			throw new ErrorException(
					"It is illegal to move the pen while you are defining a filled region.");
		} else {
	...
	public void setColor(Color color) {
		if (regionStarted) {
			throw new ErrorException(
					"It is illegal to change the color while you are defining a filled region.");
		} else {
	...
	public void setFillColor(Color color) {
		if (regionStarted) {
			throw new ErrorException(
					"It is illegal to change the fill color while you are defining a filled region.");
		} else {
			fillColor = color;
			return;
		}
	...
	public void endFilledRegion() {
		if (!regionOpen) {
			throw new ErrorException(
					"You need to call startFilledRegion before you call endFilledRegion.");
		} else {
			regionOpen = false;
			regionStarted = false;
