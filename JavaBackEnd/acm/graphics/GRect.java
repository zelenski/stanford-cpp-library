...
public class GRect extends GObject implements GFillable, GResizable {
	...
	protected void paint2d(Graphics2D graphics2d) {
		java.awt.geom.Rectangle2D.Double double1 = new java.awt.geom.Rectangle2D.Double(0.0D, 0.0D,
	...
	public GRectangle getBounds() {
		...
		return new GRectangle(rectangle2d.getX() + getX(), rectangle2d.getY() + getY(),
