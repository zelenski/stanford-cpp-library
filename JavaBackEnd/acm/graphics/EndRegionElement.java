...
class EndRegionElement extends PathElement {
	...
	public void paint(Graphics2D graphics2d, PathState pathstate) {
		...
		graphics2d.fillPolygon(pathstate.region.xpoints, pathstate.region.ypoints,
				pathstate.region.npoints);
		graphics2d.setColor(color);
		graphics2d.drawPolygon(pathstate.region.xpoints, pathstate.region.ypoints,
				pathstate.region.npoints);
