...
public class GLabel extends GObject {
	...
	public GRectangle getBounds() {
		...
		Object obj = new java.awt.geom.Rectangle2D.Double(0.0D, -fontmetrics.getAscent(),
				fontmetrics.stringWidth(label), fontmetrics.getHeight());
	...
	public String paramString() {
		return (new StringBuilder()).append(super.paramString()).append(", string=\"")
