...
public class TableConstraints extends GridBagConstraints {
	...
	public String toString() {
		...
		s = (new StringBuilder()).append(s).append("[gridx=").append(gridx).append(",gridy=")
				.append(gridy).toString();
		switch (fill) {
		case 3: // '\003'
		...
		if (gridheight != 1)
			s = (new StringBuilder()).append(s).append(",gridheight=").append(gridheight)
					.toString();
		if (ipadx != 0)
...
//	private static final int MY_LAST_LINE_END = 26;
	protected static final String LEGAL_KEYS[] = { "anchor", "bottom", "colspan", "fill",
			"gridwidth", "gridheight", "gridx", "gridy", "height", "ipadx", "ipady", "left",
			"right", "rowspan", "top", "weightx", "weighty", "width" };
