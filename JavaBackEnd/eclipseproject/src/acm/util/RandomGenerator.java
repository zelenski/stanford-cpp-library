 ...
 */
	...
	/**
	 * Creates a new random generator, using the given seed value to influence its random
 ...
 */
	 ...
	 * This is done to "rig" the random generator so it will always return the same sequence
	 * of integers, to aid in testing of programs.
	 ...
	 * Note: This will not change the seed of any previously constructed RandomGenerator object.
	 * To do that, call {@code rg.setSeed(seed);} on that object.
	 * @param seed
	 */
